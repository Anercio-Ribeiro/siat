...
// //               className += ' selected-checkin bg-black text-white border-2 border-pink-800';
// //             }
            
// //             if (endDate && date.toDateString() === endDate.toDateString()) {
// //               className += ' selected-checkout bg-black text-white';
// //             }
...
// //                 variant="ghost"
// //                 size="icon"
// //                 className="absolute right-4 top-20 mt-4 z-10 hover:bg-black hover:text-white rounded-full transition-colors"
// //               >
// //                 <ChevronRight className="h-4 w-4" />
// //               </Button>
...
//                 variant="ghost"
//                 size="icon"
//                 className="absolute left-2 top-20 z-10 mt-6 hover:bg-black hover:text-white rounded-full transition-colors"
//               >
//                 <ChevronLeft className="h-4 w-4" />
//               </Button>
//               <Button
...
//                 variant="ghost"
//                 size="icon"
//                 className="absolute right-2 top-20 z-10 mt-4 mb-8 hover:bg-black hover:text-white rounded-full transition-colors"
//               >
//                 <ChevronRight className="h-4 w-4" />
//               </Button>
//               <div className="custom-calendar-wrapper">
