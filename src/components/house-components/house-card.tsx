...
// import { Bath, Bed, Heart, ChevronLeft, ChevronRight, Car, DollarSign, Flag, Home, MapPin, ParkingCircle, Map, Pin, Edit, Info } from 'lucide-react';
...
//   // Verifica se o usuário é administrador ou o proprietário do imóvel
//   const canEdit = user && (user.role === 'ADMIN' || user.id === imovel.proprietarioId);
...
//     e.stopPropagation();
//     router.push(`/imovel/editar/${imovel.id}`);
//   };
...
//   // Verifica se os botões "Ver Detalhes" e "Editar" devem ser escondidos
//   const hideButtons = user && user.role === 'PROPRIETARIO' && pathname === '/imovel';
...
//             </div>
//           </div>
//           <CardFooter className={`flex justify-between items-center p-2 ${hideButtons ? 'bg-blue-50 h-full w-full' : 'bg-blue-50'}`}>
//             <div className="text-xs font-bold">{imovel.tipologia}</div>
//             <div className="flex space-x-4">
//               <div className="flex items-center">
//                 <Bed className="w-6 h-6 bg-blue-500 text-white p-1 rounded-md" />
    ...
    <>
      <div onClick={handleCardClick} className="cursor-pointer">
        <Card className="max-w-lg w-full rounded-md mt-6 relative">
          ...
          <CardFooter className={`flex justify-between items-center p-2 ${!showButtons ? 'bg-blue-50 h-full w-full' : 'bg-blue-50'}`}>
            <div className="text-xs font-bold">{imovel.tipologia}</div>
            <div className="flex space-x-4">
              <div className="flex items-center">
                <Bed className="w-6 h-6 bg-blue-500 text-white p-1 rounded-md" />
