...
// import PropertyLocationMap from '../map-component/map-component-back';
...
// //               {isTabLoading && activeTab === 'proximidades' ? (
// //                 <ProximidadesSkeleton />
// //               ) : (
// //                 <div className="space-y-4">
...
//   const [loadingProximidades, setLoadingProximidades] = useState(false);

//   const fetchProximidades = async () => {
//     if (!imovel?.id) return;
    
//     setLoadingProximidades(true);
//     try {
//       const response = await fetch(`/api/proximidades/${imovel.id}`);
...
//     setIsTabLoading(true);
//     setActiveTab(value);
//     if (value === 'proximidades' && proximidades.length === 0) {
//       fetchProximidades();
//     }
//     setTimeout(() => {
//       setIsTabLoading(false);
