...
//       if (imovel.proximidades && imovel.proximidades.length > 0) {
//         // Using Dynamic import to avoid SSR issues with Leaflet
//         import('leaflet').then(L => {
//           // Create map instance
//           const map = L.map('map').setView(
//             [imovel.proximidades[0].latitude, imovel.proximidades[0].longitude],
//             15
//           );
...
//           imovel.proximidades.forEach(point => {
...
//     return <div id="map" className="h-[300px] w-full rounded-md" />;
//   };
