// // /pages/api/proprietario-alugueis.ts
// import { NextApiRequest, NextApiResponse } from "next";
// import { getSession } from "next-auth/react"; // Ou sua autenticação
...
//   const proprietarioId = session.user.id;
//   const rentalRepo = new AluguelRepository();

//   const rentals = await rentalRepo.obterReservasPorProprietario(proprietarioId, Number(page), Number(pageSize));
