...
export default function RentalDetailsPage() {
  ...
  const statusMutation = useMutation({
    ...
    onError: (error) => {
      toast.error(error instanceof Error ? error.message : "Erro ao atualizar estado da reserva");
    },
  });
      ...
      >
        <div className="max-w-7xl mx-auto p-6 space-y-8">
              ...
              <Card className="col-span-1 flex flex-col">
                ...
                <CardContent className="space-y-4 flex flex-col flex-grow">
                  <Select onValueChange={setSelectedStatus} value={selectedStatus}>
                    <SelectTrigger>
                      <SelectValue placeholder="Defina estado da reserva" />
                    </SelectTrigger>
                    <SelectContent>
          ...
          <div className="grid grid-cols-2 gap-6">
           ...
           <ChatComponent
                        AluguelId={rental.id}
                        proprietarioId={rental.imovel.proprietarioId}
                        inquilinoId={rental.inquilino.id}
                        isOpen={chatOpen}
