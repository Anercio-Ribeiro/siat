...
// // import { MapPin, Bed, Bath, Calendar, User, ParkingCircle, DollarSign } from "lucide-react";
...
// //   return { success: true }; // Retorna algo para o onSuccess do useMutation
// // }
...
// //           toast.success("Estado do aluguel atualizado com sucesso");
// //           if (selectedStatus === "concluído" && !rental?.contrato) {
// //             setContractData({
// //               dataInicio: rental?.checkIn || "",
// //               dataFim: rental?.checkOut || "",
// //               valorTotal:
// //                 rental?.tipoAluguel === "RESIDENCIAL"
// //                   ? rental?.imovel.precoMensal || 0
// //                   : rental?.imovel.preco || 0,
...
// //                 <div className="flex items-center">
// //                   <Calendar className="w-5 h-5 mr-2" />
// //                   <span>Período de Aluguel: {rentalPeriod}</span>
// //                 </div>
// //                 <div className="flex items-center">
// //                   Estado: <Badge
// //                     style={{
...
// //                     Preço: {rental.imovel.preco} AOA / {rental.periodoAluguel < 30 ? "dia" : "mês"}
// //                   </p>
// //                   <p className="flex items-center">
...
// //                     <a href={rental.contrato.urlDocumento} target="_blank" rel="noopener noreferrer">
// //                       Ver Contrato
// //                     </a>
// //                   </Button>
// //                 )}
...
// // src/app/(protected)/detalhes/[id]/page.tsx
// "use client";
...
//   };
//   inquilino: { nome: string };
//   contrato?: { urlDocumento?: string }; // urlDocumento agora contém Base64
// }
...
//   // Baixar o PDF retornado pela criação
//   const blob = await response.blob();
//   const url = window.URL.createObjectURL(blob);
//   const link = document.createElement("a");
//   link.href = url;
...
// // Função para baixar o PDF a partir do Base64 armazenado
...
//                 //   ? rental?.imovel.precoMensal || 0
//                 //   : rental?.imovel.preco || 0,
//               termosContrato: `Contrato de aluguel ${rental?.tipoAluguel.toLowerCase()} entre ${rental?.inquilino.nome} e ${rental?.imovel?.proprietario?.nome}.`,
//             });
//             setIsContractModalOpen(true);
//           }
//           resolve(null);
